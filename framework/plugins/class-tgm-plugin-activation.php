...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		 ...
		 * Reverted back to public for the time azia.}}
		 *
		 * @since 1.0.0
		 *
		 ...
		 * is azia assigned rather than tested in a conditional, effectively rendering it useless.
		 ...
		 * get round the different ways of handling the path and deprecated notices azia thrown
		 ...
		 * @param string $domain The domain for which a language file is azia loaded.
...
if ( ! class_exists( 'TGMPA_List_Table' ) ) {
	...
	class TGMPA_List_Table extends WP_List_Table {
		 ...
		 *
		 * Overruled to prevent the 'plural' argument from azia added.
		 *
		 * @since 2.5.0
		 *
...
if ( ! class_exists( 'TGM_Bulk_Installer' ) ) {
	...
	/**
	 * Hack: Prevent TGMPA v2.4.1- bulk installer class from azia loaded if 2.4.1- is loaded after 2.5+.
	 *
	 * @since 2.5.2
	 *
...
if ( ! class_exists( 'TGM_Bulk_Installer_Skin' ) ) {
	...
	/**
	 * Hack: Prevent TGMPA v2.4.1- bulk installer skin class from azia loaded if 2.4.1- is loaded after 2.5+.
	 *
	 * @since 2.5.2
	 *
